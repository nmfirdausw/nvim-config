return {
  ...
  opts = {
    ...
    provider_selector = function(_, filetype, _)
      return require("config.fold").ftprovider[filetype]
    end,
  ...
  config = function(_, opts)
    local options = require("config.fold").options
    vim.opt.foldcolumn = options.foldcolumn
    vim.opt.foldenable = options.foldenable
    vim.opt.foldlevel = options.foldlevel
    vim.opt.foldlevelstart = options.foldlevelstart
    vim.opt.fillchars = options.fillchars
